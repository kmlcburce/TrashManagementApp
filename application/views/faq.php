...
<div class="container">
	...
	<img src="<?php echo base_url('images/faq.jpg'); ?>" class="img-thumbnail mx-auto d-block" width="400" height="500"> <br> 

	<h3>Q: Do you have a main office?</h3>
	<p class="faqans">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam volutpat non orci in placerat. Nulla magna sapien, porta sed pulvinar in, imperdiet sagittis dui. <br>

	<h3>Q: Is there a minimum for how many goods to be donated? </h3>
	<p class="faqans"> Nulla eget erat et tellus ultrices faucibus at eget libero. Cras at consequat eros. Vestibulum volutpat nec lectus suscipit fermentum. Phasellus pharetra congue  faucibus. <br>

	<h3>Q: How many goods can a benefactor take home?</h3>
	<p class="faqans">Integer in ex ut odio scelerisque congue. Donec euismod felis eu orci iaculis, sed blandit libero pharetra. Etiam vehicula mauris at molestie gravida. Nullam sit amet augue urna. 
